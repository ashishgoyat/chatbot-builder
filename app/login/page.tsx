...
export default function LoginForm() {
  ...
  return (
    <div className="app-shell flex min-h-screen items-center py-10">
      <div className="mx-auto grid w-full max-w-4xl overflow-hidden rounded-3xl border border-white/50 bg-white/80 shadow-2xl shadow-indigo-950/10 backdrop-blur-xl dark:border-white/10 dark:bg-neutral-900 section-enter md:grid-cols-2">
        <section className="relative hidden border-r border-neutral-200/60 bg-gradient-to-br from-indigo-600 to-sky-600 p-8 text-white dark:border-white/10 md:block">
        ...
        <section className="p-6 sm:p-8">
          <div className="mb-8 reveal-up">
            <p className="text-xs uppercase tracking-[0.2em] text-neutral-500 dark:text-neutral-400">Account</p>
            <h2 className="mt-2 text-3xl font-semibold tracking-tight text-neutral-900 dark:text-neutral-100">Login</h2>
            <p className="mt-2 text-sm text-neutral-600 dark:text-neutral-400">Continue building your AI assistant.</p>
          </div>
          ...
          <p className="mt-6 text-sm text-neutral-600 dark:text-neutral-400">
            New here?{" "}
            <Link href="/signup" className="font-semibold text-neutral-900 hover:text-indigo-700 dark:text-neutral-100 dark:hover:text-indigo-400">
              Create an account
            </Link>
          </p>
        </section>
